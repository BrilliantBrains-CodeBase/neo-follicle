 ...
 *     made.
 *   - ALL NINE CARDS NOW CARRY A PHOTOGRAPH. GFC, QR678 and Exosome had none
 *     when this section was written and ran on a flat `bg-secondary` ground;
 *     building those three treatment pages brought their heroes into
 *     public/treatments/, sourced from what the OLD PAGE ITSELF rendered (see
 *     scripts/treatment-assets.mjs), so each card now shows the treatment it
 *     links to rather than a dark tile.
 *
 ...
 *
 * IMAGE PROVENANCE. Nothing here is new stock. The six under public/services/
 * are the home page's own service cards (five licensed stock carried over from
 * the live site, /services/female.webp client-supplied); /gallery/gfc-prp.webp
 * is the image gallery's regenerative-treatment photograph; and the three under
 * public/treatments/ are generated by scripts/gen-treatment-images.mjs from the
 * images the OLD PAGE for that treatment actually rendered. Alt text describes
 * the image only and claims no result.
 */
const CATEGORIES = [
  {
