 ...
 *   WhatsAppIcon, CalendarCheck  Font Awesome Free 6 (fab_whatsapp,
 *            far_calendar-check). Nothing equivalent was captured -- the
...
/**
 * The sticky action bar's two glyphs. Call reuses `Phone` (the hand-drawn
 * 24x24 one the header already uses), NOT `PhoneIcon` -- that one is the
 * y-flipped jki glyph and would sit at a different optical weight beside these.
 */
...
export function CalendarCheck({ className }: IconProps) {
  return (
    <svg viewBox="0 0 448 512" fill="currentColor" aria-hidden="true" focusable="false" className={className}>
      <path d="M400 64h-48V12c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v52H160V12c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v52H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zm-6 400H54c-3.3 0-6-2.7-6-6V160h352v298c0 3.3-2.7 6-6 6zm-52.8-200.9l-17.8-18c-4.7-4.7-12.3-4.7-17-.1L192.7 358.5l-52.3-52.7c-4.7-4.7-12.3-4.7-17-.1l-18 17.8c-4.7 4.7-4.7 12.3-.1 17l78.6 79.2c4.7 4.7 12.3 4.7 17 .1l142.3-141.2c4.7-4.7 4.7-12.3.1-17z" />
    </svg>
  )
}
